...
# Photos
> Add photos by dropping images into `docs/photos/{{SLUG}}/`.
>
> Recommended:
...
**Disclaimer:** This is a personal route note, not a guarantee of safety. Always assess current conditions and consult the avalanche bulletin.
